...
- The majority of income support cases fall within a specific age range, **25-54.** This is noted by the authors of the data set used as being the "prime" labor force age range. In addition, the **55-64** age range is one of the few to have shown growth in numbers over time.
